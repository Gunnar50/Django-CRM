...
class AddRecordForm(forms.ModelForm):
    ...
    phone_number = forms.CharField(label="", required=True, max_length=100, widget=forms.widgets.TextInput(attrs={"class": "form-control", "placeholder": "Phone Number"}))
    email = forms.EmailField(label="", required=True, max_length=100, widget=forms.widgets.TextInput(attrs={"class": "form-control", "placeholder": "Email Address"}))
